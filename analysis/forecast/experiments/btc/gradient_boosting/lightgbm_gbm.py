...
logs_path = 'forecast/experiments/btc/loggers/lightgbm/metrics.csv'
...
# Save model
model.booster_.save_model(pretrained_path + 'lightgbm' + version + '.txt', num_iteration=model.booster_.best_iteration)
...
np.savetxt(predictions_path + 'lightgbm' + version + '.txt', test_pred['BTC'])
