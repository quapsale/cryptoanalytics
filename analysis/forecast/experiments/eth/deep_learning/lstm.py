...
from analysis.forecast.experiments.eth.deep_learning.dataset.datasets import DatasetV1
from torch.utils.data import DataLoader
from analysis.forecast.experiments.eth.deep_learning.models.lstm import LSTM
...
rnn_path = './analysis/forecast/experiments/eth/deep_learning/'
...
checkpoint_path = './analysis/forecast/experiments/eth/checkpoints/'
logger_path = './analysis/forecast/experiments/eth/loggers/'
...
np.savetxt(predictions_path + 'lstm' + version + '.txt', test_pred['ETH'])
