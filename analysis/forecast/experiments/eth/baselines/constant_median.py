...
baseline_path = './analysis/forecast/experiments/eth/baseline/'
...
np.savetxt(predictions_path + 'constant_median.txt', predictions)
...
with open(metrics_path, 'a') as metrics:
    ...
    writer.writerow([now, 'constant_median', '1', mse, rmse, mae, mape])
